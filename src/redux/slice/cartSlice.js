    ...
    reducers: {
        ADD_TO_CART(state, action) {
            ...
            if (productIndex >= 0) {
                ...
                toast.success(`${action.payload.name} Increased`, { position: 'top-left' })
            } else {
                // Item not exists
                // Add item to cart
        ...
        DECREASE_CART(state, action) {
            ...
            if (state.cartItems[productIndex].cartQuantity > 1) {
                state.cartItems[productIndex].cartQuantity -= 1;
                toast.info(`${action.payload.name} decreased`, { position: 'top-left' })
...
export const selectPreviousURL = (state) => state.cart.perviousURL;
